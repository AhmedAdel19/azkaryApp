...
public class CustomAdapterAzkarElmasaa extends RecyclerView.Adapter<CustomAdapterAzkarElmasaa.MyViewHolder> {
   ...
   public static DB db;
    ...
    public CustomAdapterAzkarElmasaa(Context context , int layout, ArrayList<AzkarContent> azkarList)
    {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, int position) {
        ...
        holder.saveBtn.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                db.QueryData("CREATE TABLE IF NOT EXISTS AZKAR_Masaa (ZekrId INTEGER PRIMARY KEY AUTOINCREMENT , ZekrContent VARCHAR , ZekrBless VARCHR , ZekrRebeat INTEGER)");
